    ...
    <main id="main-content">
      ...
      <section className="section section--findings" id="findings"><SectionHead index="01" eyebrow="Overview" title="Three findings organise the picture."><p className="section-intro">Together, the responses show how cultural, technical and civic questions are being noticed and navigated.</p></SectionHead>
        <div className="finding-grid">
          <article className="finding-card finding-card--signal"><span className="finding-number">01</span><h3>The future is cultural, technical and civic at once.</h3><p>Arts education and creative practice led the concerns, while social cohesion, political pressure and AI appeared as closely connected forces—not separate lanes.</p><blockquote className="respondent-quote"><p>“I am interested in/concerned about how AI will influence creative practices and our perception of the world … I am also very concerned with how the arts will be perceived in times of conflict, war, climate change, far-right extremism.”</p><cite>Quote from an anonymous survey respondent · excerpt</cite></blockquote><div className="mini-stats" aria-label="Leading concern themes"><span><strong>58%</strong> arts education</span><span><strong>42%</strong> social cohesion</span><span><strong>39%</strong> politics &amp; conflict</span></div></article>
