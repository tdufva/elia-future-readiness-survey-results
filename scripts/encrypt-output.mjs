...
<style>:root{color-scheme:light;--paper:#dce8e6;--light:#f7fbfa;--ink:#173130;--soft:#506765;--signal:#2f7972;--rule:#aabfbb}*{box-sizing:border-box}body{margin:0;min-height:100vh;display:grid;place-items:center;padding:28px;color:var(--ink);background:var(--paper);font-family:Inter,ui-sans-serif,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif}.gate{width:min(720px,100%);padding:clamp(32px,6vw,66px);background:rgba(247,251,250,.9);border:1px solid rgba(23,49,48,.13);border-radius:26px}.mark{display:grid;width:46px;height:46px;place-items:center;color:var(--light);background:var(--ink);border-radius:14px;font-family:ui-rounded,"Arial Rounded MT Bold","Avenir Next Rounded",sans-serif;font-weight:800}.eyebrow{margin:34px 0 12px;color:#1d5c57;font-size:.72rem;font-weight:800;letter-spacing:.14em;text-transform:uppercase}h1{margin:0;font-family:ui-rounded,"Arial Rounded MT Bold","Avenir Next Rounded",Inter,sans-serif;font-size:clamp(2.4rem,7vw,5rem);font-weight:800;letter-spacing:-.05em;line-height:.98}p{max-width:580px;color:var(--soft);line-height:1.65}form{margin-top:36px}label{display:block;margin-bottom:8px;font-size:.72rem;font-weight:800;letter-spacing:.08em;text-transform:uppercase}.row{display:flex;gap:10px}input{min-width:0;flex:1;padding:14px 16px;color:var(--ink);background:white;border:1px solid var(--rule);border-radius:999px;font:inherit}button{padding:14px 22px;color:var(--light);background:var(--ink);border:0;border-radius:999px;font:inherit;font-weight:800;cursor:pointer}button:hover{background:var(--signal)}input:focus,button:focus{outline:3px solid #145f78;outline-offset:2px}.error{min-height:24px;margin:10px 0 0;color:#9b2c20;font-size:.84rem}@media(max-width:520px){.row{flex-direction:column}button{width:100%}}</style></head>
